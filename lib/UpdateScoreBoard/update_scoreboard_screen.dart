...
class _UpdateScoreboardScreenState extends State<UpdateScoreboardScreen>
  ...
  bool isApplingUpdateScore = false;
  ...
  Future<void> applyScore() async {
    ...
    setState(() {
      isApplingUpdateScore = true;
    });

    Map<String, dynamic> successMsg = await context
        .read<UpdateScoreboardService>()
        .update(
          playerId: widget.id,
    ...
    setState(() {
      isApplingUpdateScore = false;
    });

    if (successMsg[Constants.SUCCESSKEY]) {
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: isApplingUpdateScore ? null : applyScore,
                            child: const Text(
                              "🎮 APPLY SCORE",
                              style: TextStyle(
                                fontSize: 18,
